...
class FinHubAPIProvider: FinhubAPIService {
    ...
    func fetchStockSymbols() async throws -> [StockSymbol] {
        return try await httpClient.request(endpoint: FinnhubEndpoint(endpointType: .stockSymbols, keyService: keyService))
    }
    ...
    func searchStocks(query: String) async throws -> StockSearchResult {
        return try await httpClient.request(endpoint: FinnhubEndpoint(endpointType: .search(query: query), keyService: keyService))
    }
    ...
    func fetchCompanyProfile(symbol: String) async throws -> CompanyProfile {
        return try await httpClient.request(endpoint: FinnhubEndpoint(endpointType: .companyProfile(symbol: symbol), keyService: keyService))
    }
    ...
    func fetchStockQuote(symbol: String) async throws -> StockQuote {
        return try await httpClient.request(endpoint: FinnhubEndpoint(endpointType: .quote(symbol: symbol), keyService: keyService))
    }
}
